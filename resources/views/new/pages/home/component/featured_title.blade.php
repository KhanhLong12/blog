...
<div class="row">
    <div class="col-lg-8">
        ...
        <div class="post_item post_v_large d-flex flex-column align-items-start justify-content-start">
            <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                <div class="post_image"><img src="{{ asset('user/images/article/L3Yuzln8II.png') }}"
                                             alt="{{ asset('user/images/article/L3Yuzln8II.png') }}"
    ...
    <div class="col-lg-4">
        <div>
            <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                <div class="post_image"><img src="{{ asset('user/images/article/iQ1RXPioFZ.jpeg') }}"
                                             alt="{{ asset('user/images/article/iQ1RXPioFZ.jpeg') }}"
                                             class="img-fluid w-100"></div>
                <div class="post_content">
                    <div class="post_category cat_technology ">
                        <a href="the-loai/the-thao-1.html">Thể thao</a>
        ...
        <div>
            <div class="post_item post_v_small d-flex flex-column align-items-start justify-content-start">
                <div class="post_image"><img src="{{ asset('user/images/article/hoyOyXJrzx.png') }}"
                                             alt="{{ asset('user/images/article/hoyOyXJrzx.png') }}"
                                             class="img-fluid w-100"></div>
                <div class="post_content">
                    <div class="post_category cat_technology ">
