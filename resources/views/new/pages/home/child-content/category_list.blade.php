<div class="technology">
    ...
    <div class="technology_content">
        <div class="post_item post_h_large">
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{ asset('user/images/article/e7YyFZJCc8.jpeg') }}"
                                                 alt="{{ asset('user/images/article/e7YyFZJCc8.jpeg') }}"
        ...
        <div class="post_item post_h_large">
            <div class="row">
                <div class="col-lg-5">
                    <div class="post_image"><img src="{{ asset('user/images/article/exzJEG4WDU.jpeg') }}"
                                                 alt="{{ asset('user/images/article/exzJEG4WDU.jpeg') }}"
                                                 class="img-fluid w-100"></div>
                </div>
                <div class="col-lg-7">
                    <div class="post_content">
